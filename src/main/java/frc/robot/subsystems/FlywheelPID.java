...
public class FlywheelPID extends PIDSubsystem {
   ...
   private static WPI_TalonSRX flywheel1 = new WPI_TalonSRX (FlywheelConstants.kflywheel1);
   private static WPI_TalonSRX flywheel2 = new WPI_TalonSRX (FlywheelConstants.kflywheel2);
  ...
  flywheel2.set(speed);
  SmartDashboard.putNumber("Rate", getRate());
  SmartDashboard.putNumber("Pos", flywheel1.getSelectedSensorPosition());
  //flywheel1.getSensorCollection().setAnalogPosition(newPosition, timeoutMs)
}
